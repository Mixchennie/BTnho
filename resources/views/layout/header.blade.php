            ...
            <div class="pull-right auto-width-right">
                <ul class="top-details menu-beta l-inline">
                    ...
                    <li class="nav-item dropdown" style="position: relative">
                        <a onclick="()=>{document.querySelector('.dropdown-menu-profile').style.display='block'}"class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu-profile">
                            <li >
                                <a>Name: <span>{{Auth::user()->name}}</span></a>
                                <a>mail: <span>{{Auth::user()->email}}</span></a>
                            </li>
                        ...
                        <div class="beta-select"><i class="fa fa-shopping-cart"></i> Giỏ hàng (@if(Session::has('cart')){{ Session('cart')->totalQty }} 
                            ...
                            <div class="beta-dropdown cart-body">
                                ...
                                <div class="cart-caption">
                                    ...
                                    <div class="center">
                                        <div class="space10">&nbsp;</div>
                                        <a href="/list-cart" class="beta-btn primary text-center">Xem gio hàng <i class="fa fa-chevron-right"></i></a>
                                    </div>
                                    <div class="center">
                                        <div class="space10">&nbsp;</div>
                    ...
                    <li><a href="#">Sản phẩm</a>
                        <ul class="sub-menu">
                            @foreach ($producttypes as $item)
                                <li><a href="{{route('getProductType',$item->id)}}">{{$item->name}}</a></li>
                            @endforeach
                        </ul>
                    </li>
