        ...
        <div class="table-responsive">
            ...
            <table class="shop_table beta-shopping-cart-table" cellspacing="0">
                ...
                <tbody>
                    ...
                    <form action="/update-cart/{{$product["item"]["id"]}}">
                        @csrf
                        <tr class="cart_item">
                            ...
                            <td class="product-quantity">
                                <input name="product-qty" id="product-qty" type="number" value="{{$product['item']['qty']}}">
                                <button type="submit" class="beta-btn primary">Update Cart <i class="fa fa-chevron-right"></i></button> 
